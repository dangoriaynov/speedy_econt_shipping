...
global $speedy_region_sel, $speedy_city_sel, $speedy_office_sel, $econt_region_sel, $econt_city_sel, $econt_office_sel,
       ...
       $shipping_to_speedy_key, $shipping_opts_order_default, $delivery_price_selector_default, $free_from_not_set,
       $delivery_details_default;
...
$delivery_details_default = '<th>Доставка</th><td data-title="Доставка">Преминете към следваща стъпка за опциите на доставка</td>';
$free_from_not_set = -1;
